...
# Respectively : fd, right, left, do nothing
...
if __name__ == '__main__':
    ...
    while True:  # Run until solved
        ...
        print("Episode {} ==> {} tiles visited (reward = {})".format(episode_count, env.tile_visited_count, episode_reward))
